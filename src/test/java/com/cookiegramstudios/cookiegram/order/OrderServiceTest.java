...
public class OrderServiceTest {
    ...
    void getTodaysOrders_delegatesToRepositoryWithTodaysDate() {
        ...
        when(orderRepository.findByDeliveryDateOrderByCreatedAtAsc(today))
    ...
    void getOrdersByDeliveryDate_delegatesToRepositoryWithGivenDate() {
        ...
        when(orderRepository.findByDeliveryDateOrderByCreatedAtAsc(date))
                .thenReturn(List.of(sampleOrder));
    ...
    void getOrdersByStatus_inProgressStatus_delegatesCorrectly() {
        ...
        when(orderRepository.findByStatus(OrderStatus.IN_PROGRESS))
    ...
    void getTodaysOrdersByStatus_delegatesWithTodayAndStatus() {
        LocalDate today = LocalDate.now();
        when(orderRepository.findByDeliveryDateAndStatus(today, OrderStatus.PLACED))
                .thenReturn(List.of(sampleOrder));
    ...
    /**
     * updateOrderStatus with an unknown ID should throw a RuntimeException
     * and never call save.
     */
    @Test
