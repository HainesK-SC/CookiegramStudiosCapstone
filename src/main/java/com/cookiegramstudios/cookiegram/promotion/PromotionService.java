...
public class PromotionService {
	 ...
	 * @return promotionById: Promotion - A Promotion object with the corresponding
	 *         ID.
	 */
	@Transactional
	 ...
	 * 
	 * @param promoCode: String - The unique promotional code of the Promotion (e.g.
	 *                   SPRING25)
	 * @return promotion: Promotion - A Promotion object with the corresponding
	 *         promoCode value.
	 */
	@Transactional
	 ...
	 * 
	 * @param promoType: PromotionTypes - A value from the PromotionTypes
	 *                   enumeration (FIXED or PERCENTAGE).
	...
	/**
	 * Find Promotion(s) by promotion value. This value will be represented by a
	 * dollar figure or by a percentage figure. Percentages are shown as whole
	 * numbers (not decimals).
	 * 
	 * @param promoValue: double - The decimal figure.
	 * @return promotions: List<Promotion> - Promotion object(s) that match the
	 *         given value.
	 */
	@Transactional
	 ...
	 * @return promotions: List<Promotion> - Promotion object(s) that started on the
	 *         given date.
	 */
	@Transactional
	 ...
	 * @return promotions: List<Promotion> - Promotion object(s) that are currently
	 *         active.
	 */
	@Transactional
	...
	/**
	 * Validates that any given user object is valid. This checks if the overall
	 * object is null, as well as validating and verifying member variable
	 * variables.
	 * 
	 * @param promotion: Promotion - The Promotion object to verify.
	 * @return isValid: boolean - A truthy value whether the Promotion object is
	 *         valid or not.
	 * @throws InvalidPromotionDataException: RuntimeException - An exception that
	 *                                        indicates to the user the error or
	 *                                        discrepancy related to the Promotion
	...
	private boolean validatePromotionObject(Promotion promotion) throws InvalidPromotionDataException {
		...
		if (promotion.promoType != PromotionTypes.FIXED && promotion.promoType != PromotionTypes.PERCENTAGE) {
			throw new InvalidPromotionDataException(
