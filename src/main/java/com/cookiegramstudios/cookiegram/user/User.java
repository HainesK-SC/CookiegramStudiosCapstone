 ...
 * <p>
 * Users are authenticated and authorized based on their assigned role. Each
 * user has a unique ID and email address, with the email serving as the login
 * identifier.
 * </p>
 * <p>
 ...
 * <li><b>email</b> - User's email address, used for authentication and
 * login</li>
 * <li><b>password</b> - User's password, stored securely (should be
 * encrypted)</li>
 * <li><b>role</b> - User's role within the system, determines access
 * permissions</li>
